 CREATE OR REPLACE STORAGE INTEGRATION PBI_Integration
  ...
  STORAGE_PROVIDER = 'S3'
  ENABLED = TRUE
  STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::362503273815:role/powerbi.pjt1.role'
  STORAGE_ALLOWED_LOCATIONS = ('s3://powerbi.pjt/')
...
//create a duplicate table agriculture from orginal dataset
